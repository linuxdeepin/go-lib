...
func TestService_Export(t *testing.T) {
	...
	srvObj1 := &srvObject1{}
	err = service.Export("/com/deepin/lib/Object1", srvObj1.GetInterfaceName(), srvObj1)
	if err != nil {
	...
	err = service.Export("/com/deepin/lib/Object12", srvObj12.GetInterfaceName(), srvObj12)
	if err == nil {
		t.Error("Expected error due to srvObj12 is not a struct pointer")
	}

	srvStr := srvString("hello")
	err = service.Export("/com/deepin/lib/String", srvStr.GetInterfaceName(), srvStr)
	if err == nil {
...
func TestService_EmitPropertiesChanged(t *testing.T) {
	...
	srvObj4 := &srvObject4{}
	err = service.Export("/com/deepin/lib/Object4", srvObj4.GetInterfaceName(), srvObj4)
	if err != nil {
...
func TestService_AutoQuit(t *testing.T) {
	...
	err = service.Export("/com/deepin/lib/Object5", srvObj5.GetInterfaceName(), srvObj5)
	if err != nil {
...
func TestService_SetReadCallback(t *testing.T) {
	...
	serverObject6, err := service.NewServerObject("/com/deepin/lib/Object6")
	if err != nil {
		t.Error("Unexpected error:", err)
	}
...
func TestService_SetWriteCallback(t *testing.T) {
	...
	serverObject7, err := service.NewServerObject("/com/deepin/lib/Object7")
	if err != nil {
		t.Error("Unexpected error:", err)
	}
...
func TestService_ConnectChanged(t *testing.T) {
	...
	serverObject8, err := service.NewServerObject("/com/deepin/lib/Object8")
	if err != nil {
		t.Error("Unexpected error:", err)
	}
...
func TestService_StructProp(t *testing.T) {
	...
	serverObject10, err := service.NewServerObject("/com/deepin/lib/Object10")
	if err != nil {
		t.Error("Unexpected error:", err)
	}
...
func TestService_DumpProperties(t *testing.T) {
	...
	err = service.Export("/com/deepin/lib/Object11", srvObj11.GetInterfaceName(), srvObj11)
	if err != nil {
...
func TestService_IntUintProp(t *testing.T) {
	...
	serverObject13, err := service.NewServerObject("/com/deepin/lib/Object13")
	if err != nil {
		t.Error("Unexpected error:", err)
	}
